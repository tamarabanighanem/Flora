    ...
    <div>
        ...
        <main className="flex overflow-hidden">
            <div className="flex-1 hidden lg:block">
                <img src="https://images.unsplash.com/photo-1618944728173-a9c13c562e1d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80" className="w-full h-screen object-cover" />
            </div>
                    ...
                    >
                        <div>
                            ...
                            <input
                                type="text"
                                required
                                className="w-full bg-white mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-gray-800 shadow-sm rounded-lg"
                            />
                        </div>
                        <div>
                            <label className="font-medium">
